...
# Apply dictionary
data.season = data.season.astype('str') # Changing seasons column type to string
data.season = data.season.map(season_dict) # Change values to actual written seasons
...
# Apply dictionary
data.weather = data.weather.astype('str') # Changing weather column to string
data.weather = data.weather.map(weather_dict) # Change values to actual written weathers
